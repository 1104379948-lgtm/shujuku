...
export function sanitizeSettingsForProfileSave_ACU(settingsObj: any): any {
    ...
    delete cloned.scriptLibraries;
    delete cloned.scriptLogs;
    return cloned;
}

export function ensureGlobalScriptSettings_ACU(): { userScripts: any[]; scriptLibraries: any[]; scriptLogs: any[] } {
    if (!Array.isArray(globalMeta_ACU.userScriptsGlobal)) globalMeta_ACU.userScriptsGlobal = [];
    if (!Array.isArray(globalMeta_ACU.scriptLibrariesGlobal)) globalMeta_ACU.scriptLibrariesGlobal = [];
    ...
    return {
        ...
        scriptLibraries: globalMeta_ACU.scriptLibrariesGlobal,
